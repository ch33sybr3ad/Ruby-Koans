...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # * would fail if the left and right side of the regex failed
    # for example "aabbcc"[/y*z/] would fail
  end
  ...
  #
  # Why?
  # They are considered greedy because they will get all of the possible matches
  # ------------------------------------------------------------------
