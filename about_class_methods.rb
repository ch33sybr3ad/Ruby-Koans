...
class AboutClassMethods < Neo::Koan
  ...
  # I prefer using the self method because it's more clear to me
  # but using the class << self method could be helpful if there were a lot of class methods and very few isntance methods
  # ------------------------------------------------------------------
